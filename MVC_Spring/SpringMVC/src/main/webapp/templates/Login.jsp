		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					<li class="nav-item"><a
						class="nav-link js-scroll-trigger" href="/hello">Home</a></li>
					<li class="nav-item"><a class="nav-link js-scroll-trigger active"
			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="container-login100-form-btn m-t-32">
						<a class="login100-form-btn"  href="/register">Register</a>
						<button class="login100-form-btn m-l-10">Login</button>
					</div>
