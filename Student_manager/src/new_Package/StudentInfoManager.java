...
public class StudentInfoManager {
	...
	/*
	 * EditStudent edit info student by student_id in list StudentInfo and save it
	 * again in file. Use editInfoId,.. to edit info in StudentInfo.
	 */
	...
	/*
	 * Sort list StudentInfo from file Sort by GPA and Sort by Name Use enum SortBy
	 */
	public void sortBy(String type) {
		...
		if (type.equals(SortBy.SortbyGPA.getvalue())) { // Sort by GPA
			TreeSet<StudentInfo> studentTree = StudentInfoDAO
					.loadByGPA("E:\\JavaTraining\\Student_manager\\StudentInfoDAO.txt");
	...
	public void sortByName(HashMap<Integer, StudentInfo> mapStudent) {
		mapStudent.entrySet().stream().sorted(Map.Entry.<Integer, StudentInfo>comparingByKey()).forEach(entry -> {
	...
	public void printCSV(String FileName, String link) throws IOException {
		String File = FileName; // link file will write info
		FileOutputStream fout = null;
		this.mapStudent = StudentInfoDAO.loadStudent(link);
		try {
			fout = new FileOutputStream(File);
			OutputStreamWriter csvFile = new OutputStreamWriter(fout);
			csvFile.write("Info_ID,Student_ID,Address,Score,Date of birth");
			csvFile.write("\n");
...
//				address = address.replaceAll(",", "-");
	...
	public void printStudentInfo(String linkFile, String linkStudent) throws IOException {
		// Load list StudentInfo from file
		this.mapStudent = StudentInfoDAO.loadStudent(linkStudent);
		...
		objectOutputStream.writeObject(this.mapStudent);
		objectOutputStream.close();
		fileOutputStream.close();
	}

	@SuppressWarnings("unchecked")
	public void readStudentInfo(String linkFile) throws IOException, ClassNotFoundException {
		// Load list StudentInfo from file
		File file = new File(linkFile);
		if (!file.exists()) {
			file.createNewFile();
		...
		this.mapStudent = (HashMap<Integer, StudentInfo>) objectInputStream.readObject();
		mapStudent.forEach((key, value) -> {
			value.printInfoPretty();
		});
